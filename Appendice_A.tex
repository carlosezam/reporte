...
En la sección \ref{subsection:umlclases}, página \pageref{subsection:umlclases} se mostró el siguiente diagrama UML con elementos omitidos, ahora se presentarán el resto de diagramas sin elementos omitidos.
...
El siguiente diagrama modela los elementos omitidos de las clases \textit{SensorVehiculos} y \textit{MySensor} del diagrama \ref{uml:relaciones}, además, se modela su relación de herencia y \emph{realización}.\\
...
El siguiente diagrama modela los elementos omitidos de las clases \textit{FuzzySemaforo} y \textit{MySemaforo} del diagrama \ref{uml:relaciones}, además, se modela su relación de herencia y \emph{realización}.\\
