...
\begin{figure}[H]
	\centering
	\subfigure[Superficie A]{\includegraphics[width=7.8cm]{Surfaces/surface_a.eps}}
	\subfigure[Superficie B]{\includegraphics[width=7.8cm]{Surfaces/surface_b.eps}}
	\subfigure[Superficie C]{\includegraphics[width=7.8cm]{Surfaces/surface_c.eps}}
	\subfigure[Superficie D]{\includegraphics[width=7.7cm]{Surfaces/surface_d.eps}}
...
\begin{figure}[H]
	...
	\caption{Repartos de tiempo de la intersección \textit{A}}
\end{figure}
