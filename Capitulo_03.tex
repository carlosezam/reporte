...
Entre los diversos métodos que existen para obtener la salida del sistema, uno de los más usados es el método de \textit{centroide} que consiste en determinar el centro de gravedad del area resultante bajo la curva del conjunto resultado.
