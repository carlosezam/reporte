...
\begin{wrapfigure}{r}{5.5cm}
	...
	\captionof{figure}{Equema de una RNA}
	\vspace{-\baselineskip}
\end{wrapfigure}
...
Entre los diversos métodos que existen para obtener la salida del sistema, uno de los más usados es el método de centroide que consiste en determinar el centro de gravedad del area resultante bajo la curva del conjunto resultado.
...
\begin{figure}[H]
	...
	\filldraw [gray] (3.7,0.8) circle [radius=4pt];
	
	\draw[->] (0,0) -- (7,0) 	node[right] {$x$} 		coordinate (x axis);
	\draw[->] (0,0) -- (0,2) 	node[above]	{$\mu(x)$} 	coordinate (y axis);
	
	\draw [arrows = {-Stealth[inset=0pt, length=10pt]},gray,dashed,very thick] (3.7,0.6) -- (3.7,-0.5);
