...
\begin{wrapfigure}{r}{9cm}
	\includegraphics[width=8.5cm]{Sources/neurona.png}
...
\begin{wrapfigure}{l}{6cm}
	%	\vspace{0.2cm}
	\includegraphics[width=5.9cm]{Sources/modelo_neurona.png}
...
\newpage
En la figura \ref{fig:fuzzify} se aprecia gráficamente un ejemplo de un proceso de inferenciación, a saber, de tipo mamdani. Existen varios mecanismos de inferencia, la elección de uno de ellos dependerá de la situación. Algunos de los métodos de inferencia más usados son:
{\setlength{\baselineskip}{0.7\baselineskip}\begin{itemize}
		\item Mamdani.
		\item Sugeno.
		\item Tsukamoto.
