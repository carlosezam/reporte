...
\begin{itemize}
	\item Número de carriles por avenida avenidas.
...
primary/.style={text width=2.5cm, font=\footnotesize , inner sep=3pt },
depto/.style={anchor=north, minimum height=4.2em, text width=1.8cm, font=\footnotesize},
depto2/.style={anchor=north, minimum height=4em, text width=2.5cm, font=\footnotesize},
proyec/.style={anchor=north, minimum height=4em, text width=1.8cm, font=\footnotesize},
office/.style={anchor=west, minimum height=3.2em, text width=2.2cm, font=\footnotesize},
