...
En la ciudad de Tapachula Chiapas el índice demográfico se encuentra en constante crecimiento, aumentando el número de desplazamientos que se realizan en la ciudad. Con ello, la movilidad urbana se ha visto afectada, siendo esta un factor importante para la productividad económica de la ciudad, para la calidad de vida de sus ciudadanos y para el acceso a servicios básicos de salud y educación.

El número de desplazamientos, sobre todo en vehículos automotores, seguirá en aumento. Desafortunadamente los semáforos convencionales tienen asignados tiempos fijos para el cambio de luces, esto ocasiona largos tiempos de espera a menudo innecesarios\footnote{e.g cuando un semáforo asigna una fase verde con un tiempo considerable a una avenida en la que hay pocos, o incluso, ningún automóvil}. Por ello es importante optimizar el flujo de trafico no solo con vialidades mejor planificadas, sino también adoptando el uso de nuevas tecnologías como los \textbf{Semáforos Inteligentes}.  
...
En el presente documento se redacta el desarrollo de un sistema “inteligente” que hará uso de herramientas y técnicas de Inteligencia Artificial para la sincronización de los semáforos. Dicho sistema será capaz de gestionar una intersección de 2 vías con un solo sentido, o incluso una intersección de 4 vías con doble sentido. Para esto, el sistema reaccionará a variables de su entorno como:

{\setlength{\baselineskip}{0.5\baselineskip}
\begin{itemize}
	\item Número de carriles por avenida.
	\item Cantidad de vehículos presentes por avenida y en toda la intersección.
\end{itemize}}
...
A continuación se describen los datos del “Instituto Tecnológico de Tapachula”, lugar en donde se desarrolló el proyecto. También se encuentra información acerca de la localización y el área en donde se elaboró el proyecto.
...
\subsection*{Valores}
\begin{multicols}{3}
{\setlength{\baselineskip}{0.5\baselineskip}\begin{itemize}
\item El ser humano.
\item El liderazgo.
\item La calidad.
...
every node/.style={fill=gray!30,rounded corners,align=center},
...
\node [depto] at (2.2,-4.2) (depqb) {\textsc{Depto. de ingeniería quimica y bioquímica}};
...
\node [office] at (-7,-13.6) (officeb1) {\textsc{Oficina de programación y evaluación presupuestaria}};
\node [office] at (-4,-13.8) (officeb2) {\textsc{Oficina de servicio social y desarrollo comunitario}};
...
\node [office] at (-7,-15.1) (officec1) {\textsc{Oficina de servicios externos}};
\node [office] at (-4,-15.4) (officec2) {\textsc{Oficina de construcción y equipamiento}};
...
\pagebreak
\subsubsection*{Macro localización}
La figura~\ref{fig:macroloc} muestra una vista aérea de la macro localización de las instalaciones del Instituto Tecnológico de Tapachula.

\begin{figure}[H]
\centering
\includegraphics[scale=0.77]{sources/macrolocalizacion.png}
\caption{Macro localización del Instituto Tecnológico de Tapachula}\label{fig:macroloc}
\end{figure}

%\newpage
%\pagebreak
\subsubsection*{Ubicación del área en donde se elaboró el proyecto}
...
\begin{figure}[!hb]
\centering
\includegraphics[scale=0.79]{sources/microlocalizacion.png}
\caption{Micro localización del Departamento de Sistemas y Computación}\label{fig:microloc}
\end{figure}
...
Tomando en cuenta los puntos antes mencionados, se considera importante, que en la ciudad de Tapachula, Chiapas, cuente con un sistema inteligente que permita controlar de manera eficiente el flujo vehicular, para lograr este objetivo será necesario que el sistema sea capaz de realizar el conteo de los automóviles de una forma inteligente y rápida, logrando con ello tener un control que permita administrar el tiempo de espera de manera más eficiente.
